						...
						<form action="myaccount.php" method="post">
							...
							<fieldset>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" placeholder="Enter your username" name="CUS_USERNAME" class="input-xlarge">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Password</label>
									<div class="controls">
										<input type="password" placeholder="Enter your password" name="CUS_PASSWD" class="input-xlarge">
									</div>
								</div>
								<div class="control-group">
						...
						<form action="sucess.php" method="post" class="form-stacked">
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" placeholder="Enter your name" name="CUS_NAME" class="input-xlarge">
									</div>
                                </div>
                                <div class="control-group">
									<label class="control-label">Telephone:</label>
									<div class="controls">
										<input type="text" placeholder="Enter your telephone number" name="CUS_TEL" class="input-xlarge">
									</div>
                                </div>
								<div class="control-group">
									<label class="control-label">Address:</label>
									<div class="controls">
										<input type="text" placeholder="Enter your address" name="CUS_ADDR" class="input-xlarge">
									</div>
                                </div>							                            
								<hr>
