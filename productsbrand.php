...
<?php $prodbrand = $_GET['brand'];?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Brand - SB</title>
    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<section class="header_text sub">
				<h4><strong><?php echo $prodbrand;?> PRODUCTS</strong></h4>
			</section>
			<section class="main-content">
				...
				<div class="row">						
					<div class="span9">								
                        ...
                        <?php $count=0;
				 	$q="select * from product Where PROD_BRAND LIKE '%$prodbrand%'";
                    ...
                    while ($row=$result->fetch_array()) { ?>
							<li class="span3">
								<div class="product-box">
									...
									<p><a href="product_detail.php?id=<?=$row['PROD_ID']?>"><img src="themes/images/cosmetic/<?=$row['PROD_PICID']?>.jpg" alt="" /></a></p>
									<a href="product_detail.php?id=<?=$row['PROD_ID']?>" class="title"><?=$row['PROD_NAME']?></a><br/>
									<a href="productsbrand.php?brand=<?=$row['PROD_BRAND']?>" class="category"><?=$row['PROD_BRAND']?></a>
					...
					<div class="span3 col">
						<div class="block">	
                    		...
                    		while ($count<3) {
								...
								<li>
									<a href="product_detail.php?id=<?=$row['PROD_ID']?>" title="<?=$row['PROD_NAME']?>">
										<img src="themes/images/cosmetic/<?=$row['PROD_PICID']?>.jpg" alt="#">
									</a>
									<a href="product_detail.php?id=<?=$row['PROD_ID']?>"><?=$row['PROD_NAME']?></a>
								</li>
								<?php $count++;} ?>	
							</ul>
						</div>
